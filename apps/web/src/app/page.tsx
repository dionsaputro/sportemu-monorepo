...
import { Waves, Calendar, Users, CheckCircle2, ArrowRight, Clock, Shield, Receipt, Share2, Camera, Smartphone, BarChart3, Zap } from 'lucide-react'
    ...
    <div className="min-h-screen bg-white">
          ...
          <div className="grid items-center gap-12 lg:grid-cols-2">
            ...
            <FadeIn delay={0.2} className="relative">
              ...
              <motion.div
                ...
                className="absolute -bottom-3 -left-3 rounded-xl border border-white/50 bg-white/90 px-4 py-3 shadow-xl backdrop-blur-md"
              >
        ...
        <div className="mx-auto max-w-6xl px-4 lg:px-8">
          <FadeIn className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-4 text-base text-slate-600">
              Dari booking sampai pembayaran, satu platform untuk semuanya.
            </p>
          </FadeIn>
            ...
            {[
              ...
              return (
                <FadeIn key={feature.title} delay={i * 0.05}>
                  <div className="group rounded-2xl border border-slate-100 p-6 transition-all hover:border-sky-100 hover:shadow-md">
            ...
            {[
              ...
              <FadeIn key={plan.name} delay={i * 0.1}>
                <div className={`relative rounded-2xl border p-8 transition-all hover:shadow-lg ${
                  plan.popular ? 'border-sky-200 bg-white ring-2 ring-sky-100' : 'border-slate-200 bg-white'
                }`}>
                  {plan.popular && (
      ...
      <section className="bg-slate-50 py-24">
        <div className="mx-auto max-w-6xl px-4 lg:px-8">
          ...
          <div className="mt-16 grid gap-6 md:grid-cols-3">
            {[
              { name: 'Coach Budi', role: 'Pelatih Renang, Jakarta', text: 'Sebelum Sportemu, jadwal gue berantakan di WhatsApp. Sekarang klien booking sendiri, gue tinggal approve. Revenue naik 40% karena ga ada lagi yang miss jadwal.' },
              ...
              { name: 'Andi Pratama', role: 'Personal Trainer, Tangerang', text: 'Free plan-nya udah cukup buat gue yang baru mulai. Sekarang udah upgrade ke Pro karena klien nambah terus. Worth it banget.' },
            ].map((t, i) => (
            ...
            <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-sky-700 via-sky-800 to-sky-900 p-12 md:p-20">
              ...
              <div className="relative mx-auto max-w-2xl text-center">
                <h2 className="text-3xl font-bold text-white md:text-4xl">
                  Siap digitalisasi bisnis pelatihan kamu?
                </h2>
                <p className="mx-auto mt-4 max-w-md text-base text-sky-100">
                  Daftar gratis sekarang. Tanpa kartu kredit, tanpa kontrak. Upgrade kapan aja.
                </p>
                <div className="mt-10 flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
                  <Link
                    href="/signup"
                    className="group inline-flex items-center gap-2 rounded-xl bg-white px-8 py-4 text-sm font-semibold text-sky-800 shadow-xl hover:bg-sky-50"
                  >
